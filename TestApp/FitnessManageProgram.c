...
int main()
{
	...
	printf("평균몸무게 : %.1f kg\t", average_weight(ary, count));	// 평균몸무게 출력(average_weight의 출력형이 double이므로 %lf)
...
int max_weight(Fitness** pary, int count)
{
	...
	return max_index;											// for문 실행이후 저장된 최대 몸무게의 인덱스 반환
}
